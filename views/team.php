...
<div class="container info">
    ...
    <p>She is supported by <b>Maciej Maryl</b> <a
            href="mailto:Maciej.Maryl@ibl.waw.pl"> <svg
                ...
                fill="currentColor">
                <use xlink:href="assets/bootstrap-icons.svg#at" /></svg></a>
        <a href="https://twitter.com/maciejmaryl" target="_blank"><svg
                class="bi" width="16" height="16"
                fill="currentColor">
            ...
            href="mailto:michael.rose@ip.mpg.de"> <svg
                ...
                fill="currentColor">
                <use xlink:href="assets/bootstrap-icons.svg#at" /></svg></a>
        <a href="https://twitter.com/Michael_E_Rose" target="_blank"><svg
                class="bi" width="16" height="16"
                fill="currentColor">
                <use xlink:href="assets/bootstrap-icons.svg#twitter" /></svg>
...
<h2>Country coordinators</h2>
    ...
    <b>Italy</b>
    <ul>
        <li>Eleonora Losiouk and Marcin Bartosiak</li>
        <li>E-mail: <a href="mailto:eleonora.losiouk@unipd.it" target="_blank">Eleonora.Losiouk@unipd.it</a> or <a href="mailto:marcin.bartosiak@unipv.it" target="_blank">Marcin.Bartosiak@unipv.it</a></li>
    ...
    <ul>
      <li>Ieva Tihovska</li>
      <li>E-mail: <a href="mailto:ieva.tihovska@lulfmi.lv" target="_blank">Ieva.Tihovska@lulfmi.lv</a></li>
      <li>Twitter: <a href="https://twitter.com/itaadiete" target="_blank">@itaadiete</a></li>
    </ul>
    <b>Netherlands</b>
    <ul>
      <li>Oleksandra Ivashchenko  </li>
    ...
    <ul>
        ...
        <li>E-mail: <a href="mailto:katarina.jurikova@unitn.it" target="_blank">Katarina.jurikova@unitn.it</a></li>
        <li>Twitter: <a href="https://twitter.com/KataJurikova" target="_blank">@KataJurikova</a></li>
    </ul>
    <b>Slovenia</b>
    <ul>
